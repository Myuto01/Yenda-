...
class PayClass():
    ...
    collections_subkey = "bc46edd47b844c5395bb91d49dc255e7"
    print("user")
    # Disbursement subscription key
    disbursements_subkey = "f02037eb240442e98a4bdf5c3a00379c"
    ...
    response = requests.request("POST", url, headers=headers, data=payload)
    print(response)  # This line is added to print the response
